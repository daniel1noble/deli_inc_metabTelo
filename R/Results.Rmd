...
```{r}
cc_a <- ggplot(rpt_data, aes(x = factor(temp), y = rpt, group = treatment, colour = treatment)) + 
  geom_point(position = position_dodge(0.5), size = 4) + 
  geom_errorbar(aes(ymin = Lower, ymax = Upper), width = 0, position = position_dodge(0.5), size = 0.6) + 
  scale_colour_manual(values = c("#2790F3", "#F24D2A")) +
  ylim(c(0, 0.4)) + 
...
cc_b <- ggplot(rpt_data_mode, aes(x = factor(temp), y = rpt, group = treatment, colour = treatment)) + 
  geom_point(position = position_dodge(0.5), size = 4) + 
  geom_errorbar(aes(ymin = Lower, ymax = Upper), width = 0, position = position_dodge(0.5), size = 0.6) + 
  scale_colour_manual(values = c("#2790F3", "#F24D2A")) +
  ylim(c(0, 0.4)) + 
