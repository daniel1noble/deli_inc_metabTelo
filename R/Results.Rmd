...
contrast_df <- rbind(diff_24_df,
                     diff_26_df,
                     diff_28_df,
                     diff_30_df,
                     diff_32_df,
                     diff_34_df) %>% as.data.frame()

contrast_df %<>% mutate(temp = seq(24,34, by = 2))
```
...
hot_overall_repeatability <- hot_post_5[,"sd_id__lnmr_Intercept"] / (hot_post_5[,"sd_id__lnmr_Intercept"] + hot_post_5[,"sd_samp_session__lnmr_Intercept"] + hot_post_5[,"sigma_lnmr"]) 

cold_overall_repeatability <- cold_post_5[,"sd_id__lnmr_Intercept"] / (cold_post_5[,"sd_id__lnmr_Intercept"] + cold_post_5[,"sd_samp_session__lnmr_Intercept"] + cold_post_5[,"sigma_lnmr"]) 
